...
export class EditAvatarComponent implements OnInit {
  ...
  constructor(
    ...
    this.imagenSeleccionada = usu != null && this.avatars.includes(usu.imagen) ? usu.imagen : null;
  }
  ...
  private isDisabled(): boolean {
    let usu = this.authService.getUsuario();
    return this.imagenSeleccionada == null || this.imagenSeleccionada == usu.imagen;
  }
