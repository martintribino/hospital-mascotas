...
export class EditPerfilComponent implements OnInit {
  ...
  constructor(
    ...
    this.perfilService.obtenerPerfil(this.usuario.nombreUsuario).subscribe(
      (data: IProfile) => {
  ...
  private onSubmit(event: Event) {
    ...
    this.perfilService
      .editarPerfil(this.usuario.nombreUsuario, loginBody)
      .subscribe(
  ...
  private isDisabled(): boolean {
    return (
      ...
      (isEqual(this.perfilInicial.nombre, this.editarPerfilF.nombre.value) &&
        isEqual(
          this.perfilInicial.apellido,
          this.editarPerfilF.apellido.value
        ) &&
        ...
        isEqual(
          this.perfilInicial.telefono,
          this.editarPerfilF.telefono.value
        ) &&
        isEqual(
          this.perfilInicial.domicilio,
          this.editarPerfilF.domicilio.value
        ) &&
        isEqual(
          this.perfilInicial.nombreClinica,
          this.editarPerfilF.nombreClinica.value
        ) &&
        isEqual(
          this.perfilInicial.domicilioClinica,
          this.editarPerfilF.domicilioClinica.value
        ))
    );
  }
